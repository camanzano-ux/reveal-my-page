...
const T = {
  ...
  es: {
    ...
    heroDesc: "TheraSeq es un laboratorio de análisis genéticos dedicado a clínicas y laboratorios de salud reproductiva y sus pacientes — con tecnología de secuenciación de última generación (NGS) y el más alto estándar de América Latina, utilizando además una de las únicas plataformas con validación analítica y clínica a nivel mundial (Juno Genetics).",
  ...
  en: {
    ...
    heroDesc: "TheraSeq is a genetic analysis laboratory dedicated to reproductive health clinics, labs and their patients — with next-generation sequencing (NGS) technology and the highest standard in Latin America, using one of the few platforms with worldwide analytical and clinical validation (Juno Genetics).",
